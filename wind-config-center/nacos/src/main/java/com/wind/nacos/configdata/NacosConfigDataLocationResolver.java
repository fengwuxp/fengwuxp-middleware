...
public class NacosConfigDataLocationResolver
    ...
    private List<NacosConfigDataResource> loadConfigDataResources(
        ...
        NacosConfigDataResource resource = new NacosConfigDataResource(properties,
                ...
                new NacosConfigDataResource.NacosItemConfig()
                        .setGroup(groupFor(uri, properties))
    ...
    private void registerConfigService(NacosConfigProperties properties, ConfigurableBootstrapContext bootstrapContext) {
        if (!bootstrapContext.isRegistered(ConfigService.class)) {
            try {
                ...
                throw new BeanCreationException("Nacos ConfigService 创建失败", exception);
            }
        }
    }
