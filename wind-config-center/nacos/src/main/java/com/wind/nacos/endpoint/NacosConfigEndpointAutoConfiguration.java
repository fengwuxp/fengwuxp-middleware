...
public class NacosConfigEndpointAutoConfiguration {
    ...
    @Bean
    public NacosConfigEndpoint nacosConfigEndpoint(NacosConfigProperties properties, NacosRefreshHistory nacosRefreshHistory) {
        return new NacosConfigEndpoint(properties, nacosRefreshHistory);
    }

    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnEnabledHealthIndicator("nacos-config")
    public NacosConfigHealthIndicator nacosConfigHealthIndicator(ConfigService configService) {
        return new NacosConfigHealthIndicator(configService);
    }
